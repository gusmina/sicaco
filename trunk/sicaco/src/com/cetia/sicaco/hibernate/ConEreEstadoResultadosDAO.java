 ...
 * 
 * @see com.cetia.sicaco.hibernate.ConEreEstadoResultados
...
public class ConEreEstadoResultadosDAO extends BaseHibernateDAO {
	...
	public static final String SUBRAYADO = "subrayado";
	...
	public ConEreEstadoResultados findById(java.lang.Integer id) {
		...
		try {
			ConEreEstadoResultados instance = (ConEreEstadoResultados) getSession()
					.get("com.cetia.sicaco.hibernate.ConEreEstadoResultados",
							id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(ConEreEstadoResultados instance) {
		...
		try {
			List results = getSession().createCriteria(
					"com.cetia.sicaco.hibernate.ConEreEstadoResultados").add(
	...
	public List findBySubrayado(Object subrayado) {
		return findByProperty(SUBRAYADO, subrayado);
	}
