...
<!--
	...
	function getProveedores(){
			ajaxCallNormal('${pageContext.request.contextPath}/contabilidad/relacionOrdenCompra.do','accion=findData&parametro[3]='+$("#tipoProveedor").val(),'prov');
	}
//-->
</script>
...
<html:form action="${_accion}" method="post" styleId="formId">
	<label>
		<bean:message key="lbl.mxComp.orden" />
	</label>
	<hr>
	<table align="center">
		<tr>
			...
			<td>
				<html:select property="parametro[3]" styleClass="obligatorio"
					...
					<html:option value="-1" >--Seleccione un tipo de proveedor--</html:option>
		...
		<tr>
			<td>
				<label>
					<bean:message key="lbl.mxPag.donacion" />
				</label>
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<html:select property="parametro[2]" styleClass="obligatorio"
					styleId="estadoOrden">
					<html:option value="-1">-- Seleccione una estado de orden --</html:option>
					<!-- <html:option value="A">Anulada</html:option> -->
					<html:option value="C">Cargada</html:option>
				</html:select>
			</td>
		</tr>
	</table>
...
<script type="text/javascript">
	...
	function handlerDeleteButton(cxcId){
		$('#cxcId').val(cxcId);
		var msgText = '<h3 style="color: red;">!!Eliminaci&oacute;n de Relacion Orden de Compra- Contabilidad!!</h3>'+
