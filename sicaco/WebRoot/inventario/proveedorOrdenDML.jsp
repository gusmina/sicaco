...
<html:form action="${_accion}" method="post" styleId="formId">
	<table align="center">
		...
		<tr>
			...
			<td>
				<div id="tipos">
					<html:select property="iucPutProveedorTipoPrestamoH.ctaTprTipoPrestamo.tprId" 
						styleClass="obligatorio" styleId="tprId">
	...
	<table align="center">
			...
			<td colspan="2">
				<html:submit property="accion">
	  				<bean:message key="cmd.proveedor.guardarOrden" />
	  			</html:submit>
	  			<html:submit property="accion">
	  				<bean:message key="cmd.proveedor.Regresar" />
	  			</html:submit>
	  		</td>
  		</tr>
	</table>
	<html:hidden property="proId2"/>
	<html:hidden property="putId"/>
</html:form>
