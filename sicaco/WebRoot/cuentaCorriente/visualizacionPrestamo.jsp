...
<!--
	$(document).ready(function() {
		...
		ajaxCallSincrono('${pageContext.request.contextPath}/cuentaCorriente/referenciaPersonal.do','accion=cargarRefPersonal&preId='+$('#preId').val(),'listaReferenciasPersonales');
		ajaxCallSincrono('${pageContext.request.contextPath}/cuentaCorriente/referenciaComercial.do','accion=cargarRefComercial&preId='+$('#preId').val(),'listaReferenciasComerciales');
		ajaxCallSincrono('${pageContext.request.contextPath}/cuentaCorriente/fiadorPrestamo.do','accion=cargarFiadores&preId='+$('#preId').val(),'listaFiadores');
		ajaxCallSincrono('${pageContext.request.contextPath}/cuentaCorriente/garantiaPrestamo.do','accion=cargarGarantias&preId='+$('#preId').val(),'listaGarantias');
		ajaxCallSincrono('${pageContext.request.contextPath}/cuentaCorriente/descuentosExternos.do','accion=cargarDescuentos2&preId='+$('#preId').val(),'listaDescuentos');
		ajaxCallSincrono('${pageContext.request.contextPath}/cuentaCorriente/nota.do','accion=cargarNotas&preId='+$('#preId').val(),'listaAnotaciones');
		...
		$("#nuevoMontoSolicitado").numeric({allow:"."});
...
//-->
	...
	function calculaMontoARecibir(){
		var solicitado = $("#nuevoMontoSolicitado").val();
		var actual = $("#preSaldoActualT").val();
		var otrasDeducciones = $("#otrasDeducId").val();
		var aportaciones = $("#aportacionesId").val();
		var iva = $("#ivaId").val();
		solicitado = dosDecimales(solicitado, "nuevoMontoSolicitado");
		...
		var montoARecibir = solicitado - actual - otrasDeducciones - aportaciones - iva;
		if(montoARecibir > 0 && montoARecibir < 0.01) $("#montoRecibir").val(0.0); 
		else $("#montoRecibir").val(roundNumber(montoARecibir,2));		
	}
...
<html:form action="${_accion}" method="post" styleId="formId">
	...
	<script>
				...
				<tr>
					...
					<td>
						<html:text property="secPerPersona.perDui"
							styleClass="obligatorio" size="${tamDui}" readonly="true"
							onkeyup="maskDui(this);" styleId="dui"/>
					</td>
					<td>
						<label>
					...
					<td>
						<html:text property="secPerPersona.perPrimerNombre"
							...
							styleId="primerNombre" readonly="true"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<html:text property="secPerPersona.perSegundoNombre"
							...
							styleId="segundoNombre" readonly="true"/>
					</td>
					<td>
						<label>
					...
					<td>
						<html:text property="secPerPersona.perPrimerApellido"
							...
							styleId="primerApellido" readonly="true"/>
					</td>
				</tr>
				<tr>
					<td>
		...
		<table>
				...
				<td colspan="3">
					...
					<logic:notEmpty name="cuentas">
						<html:select property="casCuenta" styleId="casCuenta"
							styleClass="obligatorio">
							<html:optionsCollection label="nombreCuenta" name="cuentas" value="id" />
						</html:select>
					</logic:notEmpty>
			...
			<tr>
				<td><label><bean:message key="lbl.pre.lineaPrestamo"/>:</label></td>
				<td colspan="2">
					<html:select property="lprId" styleClass="obligatorio" styleId="lprId" value="${form.lprId}">
			...
			<tr>
				...
				<td>
					<div id="plazoDiv">
						<html:select property="plmId" styleId="plmId" value="${form.plmId}"
							styleClass="obligatorio">
							<html:optionsCollection name="listaPlanes" value="plmId" label="plmNombre"/>
						</html:select>					
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div id="tasaInteresDiv">
						<html:select property="tinPlazoId" styleId="tinPlazoId" value="${form.tinPlazoId}"
							styleClass="obligatorio">
				...
				<tr>
					<td>
						<label>
							<bean:message key="lbl.pre.preSaldoActualT" />:
						</label>
					</td>
					<td>
						<html:text styleClass="obligatorio" maxlength="50" size="10" readonly="true"
							property="preSaldoActualT" styleId="preSaldoActualT" value="${form.preSaldoActualT}" />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<label>
							<bean:message key="lbl.pre.nuevoMontoSolicitado" />:
						</label>
						<html:text styleClass="obligatorio" maxlength="50" size="10"
							property="nuevoMontoSolicitado" styleId="nuevoMontoSolicitado" 
				...
				<tr>
					...
					<td>
						...
						<html:text styleClass="obligatorio" maxlength="50" size="10"
							property="preOtrasDeducciones" styleId="otrasDeducId" value="0.00"
				...
				<tr>
					...
					<td>
						...
						<html:text styleClass="obligatorio" maxlength="50" size="10"
							property="preIvaDeducciones" styleId="ivaId" readonly="true" value="0.00"/>								
					</td>
				</tr>
				<tr>
					<td>
	...
	<html:hidden property="preId" styleId="preId" value="${form.preId}"/>
			...
			<tr>
				...
				<td>
					<html:text maxlength="20" size="20" property="rcoMonto"
						styleClass="obligatorio" styleId="rcoMonto" />
					<span><bean:message key="msg.obligatorio" /> </span>
				</td>
			</tr>
			<tr>
	...
	<div class="stepByStepWizard" title="Fiadores" id="fxpDiv">
		<table border="0">
			<html:radio property="fiador" value="asociado" styleId="asociado">
				<bean:message key="lbl.fxp.asociado" />
			</html:radio>
			<html:radio property="fiador" value="externo" styleId="externo">
				<bean:message key="lbl.fxp.personaExterna" />
			</html:radio>
		</table>
		<table border="0">
			<tr>
			...
			<tr>
				...
				<td>
					<html:text maxlength="100" size="18"
						...
						styleClass="obligatorio" styleId="pxtJefeInmediato" />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					<html:text maxlength="30" size="18"
						...
						styleClass="obligatorio" styleId="pxtSalario" />
					<span><bean:message key="msg.obligatorio" /> </span>
				</td>
				<td>
					<label>
			...
			<tr>
				...
				<td>
					<html:text property="garValor" styleClass="obligatorio"
						maxlength="50" size="15" styleId="garValor" />
					<span><bean:message key="msg.obligatorio" /> </span>
				</td>
			</tr>
			<tr>
	...
	<div class="stepByStepWizard" title="Descuentos Externos">
		<table>
			...
			<tr>
				...
				<td>
					<html:text property="dexMonto" maxlength="13" size="13" styleClass="obligatorio" styleId="dexMonto"/>
				</td>
			</tr>
			</table>
			<table align="center">
			<tr>
				...
				<td>
					<html:submit property="accion">
						<bean:message key="cmd.dex.cancelar" />
					</html:submit>
				</td>
			</tr>
		</table>
	...
	<div class="stepByStepWizard" title="Anotaciones">
		...
		<table align="center">
			<tr>
				...
				<td>
					<input type="button" value="Eliminar" id="eliminarNota"/>					  
				</td>
				<td>
					<input type="button" value="Limpiar"
					...
					<td>
						<input type="button" value="Verificar Informacion"
							onclick="ajaxCallNormal('${pageContext.request.contextPath}/cuentaCorriente${_accion}.do',
								'accion=verificacionRefinanciamiento&ascId='+$('#ascId').val()
